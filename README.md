...
kind: Kustomization
bases:
- github.com/utilitywarehouse/kube-applier//manifests/base/server?ref=3.1.0-rc.2
```
...
```
github.com/utilitywarehouse/kube-applier//manifests/base/cluster?ref=3.1.0-rc.2
```
