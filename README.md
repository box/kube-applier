...
kind: Kustomization
bases:
- github.com/utilitywarehouse/kube-applier//manifests/base/server?ref=3.0.0-rc.8
```
...
```
github.com/utilitywarehouse/kube-applier//manifests/base/cluster?ref=3.0.0-rc.8
```
