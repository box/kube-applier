...
kind: Kustomization
bases:
- github.com/utilitywarehouse/kube-applier//manifests/base/server?ref=3.1.0-rc.1
```
...
```
github.com/utilitywarehouse/kube-applier//manifests/base/cluster?ref=3.1.0-rc.1
```
