...
func (m *MockClientInterface) Apply(path, namespace string, dryRun bool) (string, string, error) {
	ret := m.ctrl.Call(m, "Apply", path, namespace, dryRun)
	ret0, _ := ret[0].(string)
	ret1, _ := ret[1].(string)
	ret2, _ := ret[2].(error)
...
func (mr *MockClientInterfaceMockRecorder) Apply(path, namespace, dryRun interface{}) *gomock.Call {
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Apply", reflect.TypeOf((*MockClientInterface)(nil).Apply), path, namespace, dryRun)
}

// StrictApply mocks base method
func (m *MockClientInterface) StrictApply(path, namespace string, dryRun bool) (string, string, error) {
	ret := m.ctrl.Call(m, "StrictApply", path, namespace, dryRun)
	ret0, _ := ret[0].(string)
	ret1, _ := ret[1].(string)
	ret2, _ := ret[2].(error)
	return ret0, ret1, ret2
...
func (mr *MockClientInterfaceMockRecorder) StrictApply(path, namespace, dryRun interface{}) *gomock.Call {
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "StrictApply", reflect.TypeOf((*MockClientInterface)(nil).StrictApply), path, namespace, dryRun)
}
